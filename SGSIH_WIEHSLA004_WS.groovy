/*
    Description:    Calculation for SGSIH_WIEHSLA004_WS (BOD5)
    Created by:     JA
    Created:        2023-11-14
...
*/
def sdidataitem=SGS.getSDIDataitem('labvantage',${primary:s_sampleid},'SGSIH_WIEHSLA004_WS','*',${variantid}, ""+${dataset}, 'BOD5','*','max');
